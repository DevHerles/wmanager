...
" Vim Color File
" Name:       darkplus.vim
" Maintainer: https://github.com/metamist/darkplus.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/joshdick/onedark.vim/

" A companion [vim-airline](https://github.com/bling/vim-airline) theme is available at: https://github.com/joshdick/airline-darkplus.vim
...
" < https://github.com/joshdick/darkplus.vim/blob/master/README.md >
" for more information.)
if !exists("g:darkplus_termcolors")
  let g:darkplus_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:darkplus_terminal_italics")
  let g:darkplus_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
function! s:h(group, style)
  if g:darkplus_terminal_italics == 0
...
function! darkplus#set_highlight(group, style)
...
let s:colors = darkplus#GetColors()
...
call s:h("Number", { "fg": s:green }) " a number constant: 234, 0xff
call s:h("Float", { "fg": s:green }) " a floating point constant: 2.3e10
call s:h("Boolean", { "fg": s:dark_blue }) " a boolean constant: TRUE, false
call s:h("Identifier", { "fg": s:red }) " any variable name
call s:h("Function", { "fg": s:yellow }) " function name (also: methods for classes)
...
call s:h("Normal", { "fg": s:white, "bg": s:transparent }) " normal text
...
call s:h("Search", { "fg": s:black, "bg": s:red }) " Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
...
" Haskell
call s:h("haskellWhere", { "fg": s:dark_blue })
call s:h("haskellLet", { "fg": s:dark_blue })
call s:h("haskellImportKeywords", { "fg": s:dark_blue })
call s:h("haskellDeclKeyword", { "fg": s:dark_blue })
call s:h("haskellIdentifier", { "fg": s:yellow })
...
call s:h("jsStorageClass", { "fg": s:dark_blue })
call s:h("jsSuper", { "fg": s:red })
call s:h("jsTemplateBraces", { "fg": s:dark_blue })
call s:h("jsTemplateExpression", { "fg": s:blue })
call s:h("jsTemplateVar", { "fg": s:green })
call s:h("jsThis", { "fg": s:dark_blue })
